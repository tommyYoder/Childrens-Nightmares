...
namespace CompleteProject
{
    public class PlayerHealth : MonoBehaviour
    {
        ...
        // If player tag collides with health tag, then player's health will go back to 100%. Sounds will play when collecting the item, and all other sounds will stop before game object is destroyed. 
        ...
        // If damadge is true, then player's slider will update and audio source will play.
        ...
        // If isDead is true, then player shooting is disabled, Animator is played, death clip is played, audio source is played, and movement or shooting is false. 
        void Death()                                                  
        {
            isDead = true;
        ...
        // Game Over manager will reload the level when game over timer is finished.
